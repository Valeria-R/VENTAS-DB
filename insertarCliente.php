...
<form>
   <CENTER><td colspan="2" align="center" style="font-family:Times new roman;"><h3>ADICIONANDO CLIENTE</h3></td></center>
...
$sql ="INSERT INTO cliente VALUES($v_cod_cliente, $v_nom_cliente, $v_cod_ciudad, $v_cod_vendedor, $v_cod_f_pago)";
