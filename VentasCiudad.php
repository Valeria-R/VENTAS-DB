...
<BR>
<body>
	<center><h3>Ventas por ciudad</h3></center>
	<br>
<center><table class="table table-striped">
	<thead>
		<tr>
			<th width="100px">Nombre de la ciudad</th>
	...
	$sql="SELECT nom_ciudad,SUM(val_factura)as Total_ventas FROM ciudad,cliente,factura where factura.cod_cliente = cliente.cod_cliente and cliente.cod_ciudad=ciudad.cod_ciudad group by nom_ciudad ";
